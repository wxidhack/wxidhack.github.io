...
jQuery(document).ready(function(){
    jQuery('.color-switcher').addClass('hidden-switcher').removeClass('shown-switcher').animate({'right':'-225px'}, 800, "easeInOutExpo");
    jQuery('.switcher-control').click(function(){
        if(jQuery('.color-switcher').hasClass('shown-switcher')) {
            jQuery('.color-switcher').addClass('hidden-switcher').removeClass('shown-switcher').animate({'right':'-225px'}, 800, "easeInOutExpo");
        }else if(jQuery('.color-switcher').hasClass('hidden-switcher')) {
            jQuery('.color-switcher').addClass('shown-switcher').removeClass('hidden-switcher').animate({'right':0}, 800, "easeInOutExpo");
        }
    });
});